...
Gerenciador de pacotes padrão do _Python_. Instala pacotes do [Python Package Index (PyPI)](https://pypi.org/) no ambiente ativo. Já vem junto com o _Python_ — não precisa instalar separadamente.
...
Já vem com o _Python_. Para garantir que está atualizado:
...
pip install -r requirements.txt    # instala todos os pacotes de um arquivo
```
